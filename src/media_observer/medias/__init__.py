...
from .le_parisien import LeParisienMainPage
from .le_figaro import LeFigaroMainPage
from .tf1_info import Tf1InfoMainPage
...
media_collection = {
    ...
    for c in [
        ...
        ArchiveCollection(
            ...
            tz=ZoneInfo("Europe/Paris"),
            MainPageClass=LeParisienMainPage,
            logo_background_color="#fff",
            logo_content="""
        ...
        ArchiveCollection(
            ...
            tz=ZoneInfo("Europe/Paris"),
            MainPageClass=LeFigaroMainPage,
            logo_background_color="#fff",
            logo_content="""
